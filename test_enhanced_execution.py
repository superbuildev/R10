...
session_response = requests.post('https://47646602-afc3-40c0-bb39-85b09e810fea.preview.emergentagent.com/api/sessions', files=files)
...
response = requests.post(f'https://47646602-afc3-40c0-bb39-85b09e810fea.preview.emergentagent.com/api/sessions/{session_id}/execute', 
                        json=data, 
